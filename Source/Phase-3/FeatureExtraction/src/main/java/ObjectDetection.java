...
//        this.matcher5.setFittingModel(ransac);
    ...
    public void StartVideo() throws IOException {
        ...
        for (MBFImage mbfImage : video) {
            ...
            System.out.println("Video Features: " + kpl.toString());
...
//            modelImage5 = ImageUtilities.readMBF(new File("data/ChaiBisket.jpg"));
        ...
        System.out.println("Johnny Features: " + engine.findFeatures(modelF1).toString());
        double[][] MTPArray = ((MatrixTransformProvider) this.matcher1.getModel()).getTransform().getArray();
        for(int i=0; i< MTPArray.length; i++) {
            for(int j=0; j< MTPArray.length; j++) {
                System.out.println("MTPArray: " + MTPArray[i][j]);
            }
        }
