...
public class harshaBolt extends BaseBasicBolt {
    private static final Logger LOG = LoggerFactory.getLogger(harshaBolt.class);
    public void execute(Tuple tuple, BasicOutputCollector basicOutputCollector) {
        try {
            ...
            Boolean check = checkharsha(feature);
if(check == true) {
...
//            System.out.println(dateFormat.format(cal)); //2016/11/16 12:08:43
    ...
    String msg = "Suspect Harsha identified at " + dateFormat.format(cal);
    ...
    public Boolean checkharsha(double[] feature) {
