                ...
                new VideoDisplayListener<MBFImage>() {
                    ...
                    public void beforeUpdate(MBFImage frame) {
                        ...
                        for (final MBFImage face : mfaces) {
                            ...
                            File f = new File("data/roi/"+ i + ".png");
                            try {
                                frameFeatures = "";
                                ...
                                File fl = new File("data/features/features.txt");
...
//                                        FileUtils.writeStringToFile(fl,userName+ ":", "UTF-8", true);
                                        for (int j = 0; j < c.length; j++) {
                                            ...
                                            frameFeatures = frameFeatures + " " + c[j];
                                            FileUtils.writeStringToFile(fl,c[j] + " ", "UTF-8", true);
                                        }
                                        System.out.println(frameFeatures);
                                    SendFeaturesKafka sfk = new SendFeaturesKafka();
                                    sfk.sendFrameFeatures(frameFeatures);
